var BEMHTML = function() {
  ...
  var cache,
    ...
    function applyc(__$ctx) {
        ...
        if ($$block === 'b-page' && $$mode === 'mix' && !!$$elem === false && !!__$ctx.ctx._iGlobal === false) {
            {
                var _$1kmix = ('', __r0 = __$ctx.ctx, __r1 = __r0._iGlobal, __r0._iGlobal = true, __r2 = applyc(__$ctx), __r0._iGlobal = __r1, '', __r2), _$1kjsParams = ('', __r3 = $$mode, $$mode = 'js-params', __r4 = applyc(__$ctx), $$mode = __r3, '', __r4);
        ...
        if (!!$$elem === false && $$block === 'b-page' && $$mode === 'content') {
            return {
                elem: 'body',
        ...
        if (!!$$elem === false && $$block === 'b-page' && !(__$ctx['__$anflg4'] !== true) === false && $$mode === 'mix') {
            {
                var _$1gmix = ('', __r0 = __$ctx['__$anflg4'], __$ctx['__$anflg4'] = true, __r1 = applyc(__$ctx), __$ctx['__$anflg4'] = __r0, '', __r1) || [];
                _$1gmix.push({
                    block: 'i-ua',
        ...
        if (!!$$elem === false && $$block === 'b-page' && !(__$ctx['__$anflg3'] !== true) === false && $$mode === 'default') {
            {
                var _$12ctx = __$ctx.ctx, _$12dtype = ('', __r0 = $$mode, $$mode = 'doctype', __r1 = applyc(__$ctx), $$mode = __r0, '', __r1), _$12xUA = ('', __r2 = $$mode, $$mode = 'xUACompatible', __r3 = applyc(__$ctx), $$mode = __r2, '', __r3), _$12buf = [
                        _$12dtype,
                        {
                            elem: 'root',
                            content: [
